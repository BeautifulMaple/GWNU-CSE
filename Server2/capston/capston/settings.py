...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "oreo/templates/oreo"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# 정적 파일 설정
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / "oreo/static/oreo"]  # 정적 파일을 프로젝트 루트의 static 폴더에서 검색
STATIC_ROOT = BASE_DIR / 'staticfiles'   # 배포 시 사용할 정적 파일 모음 위치

# 미디어 파일 설정
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'  # 미디어 파일 업로드 저장 위치
